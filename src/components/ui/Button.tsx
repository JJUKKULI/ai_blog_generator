...
export function Button({
  ...
  const variants = {
    ...
    secondary: "bg-editorial-surface text-editorial-text border border-editorial-border hover:bg-editorial-bg",
    ghost: "bg-transparent text-editorial-muted hover:text-editorial-text hover:bg-editorial-border/50",
